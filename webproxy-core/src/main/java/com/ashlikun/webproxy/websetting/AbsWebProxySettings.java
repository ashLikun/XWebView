 ...
 */
public abstract class AbsWebProxySettings implements IAgentWebSettings, WebListenerManager {

    private WebSettings mWebSettings;
    private static final String TAG = AbsWebProxySettings.class.getSimpleName();
    ...
    public static final String USERAGENT_AGENTWEB = WebProxyConfig.AGENTWEB_VERSION;
    protected WebProxy mAgentWeb;


    public static AbsWebProxySettings getInstance() {
        return new AbsWebProxySettings() {
            @Override
            protected void bindAgentWebSupport(WebProxy agentWeb) {
    ...
    public AbsWebProxySettings() {

    }

    public final void bindAgentWeb(WebProxy agentWeb) {
        this.mAgentWeb = agentWeb;
        this.bindAgentWebSupport(agentWeb);

    }

    protected abstract void bindAgentWebSupport(WebProxy agentWeb);
    ...
    private void settings(WebView webView) {
        ...
        if (WebProxyUtils.checkNetwork(webView.getContext())) {
            //根据cache-control获取数据。
        ...
        //
        String dir = WebProxyConfig.getCachePath(webView.getContext());
