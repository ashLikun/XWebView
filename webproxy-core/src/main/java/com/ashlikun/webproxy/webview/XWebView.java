...
import com.ashlikun.webproxy.js.JsCallJava;
...
public class XWebView extends WebView implements NestedScrollingChild2 {
    ...
    public static class AgentWebClient extends MiddlewareWebClientBase {
        ...
        private XWebView mAgentWebView;

        private AgentWebClient(XWebView agentWebView) {
    ...
    public static class AgentWebChrome extends MiddlewareWebChromeBase {
        ...
        private AgentWebChrome(XWebView agentWebView) {
            this.mAgentWebView = agentWebView;
        }
