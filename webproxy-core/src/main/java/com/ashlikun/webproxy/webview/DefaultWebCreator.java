...
import com.ashlikun.webproxy.indicator.WebIndicator;
import com.ashlikun.webproxy.indicator.BaseIndicatorSpec;
...
public class DefaultWebCreator implements WebCreator {
    ...
    private ViewGroup createLayout() {
        ...
        if (mIsNeedDefaultProgress) {
            ...
            if (mHeight > 0) {
                lp = new FrameLayout.LayoutParams(-2, WebProxyUtils.dp2px(mActivity, mHeight));
            } else {
    ...
    private View webLayout() {
        ...
        if ((mWebView = mIWebLayout.getWebView()) == null) {
            ...
            WebProxyConfig.WEBVIEW_TYPE = WebProxyConfig.WEBVIEW_CUSTOM_TYPE;
        }
    ...
    private WebView createWebView() {
        ...
        if (this.mWebView != null) {
            ...
            WebProxyConfig.WEBVIEW_TYPE = WebProxyConfig.WEBVIEW_CUSTOM_TYPE;
        } else if (WebProxyConfig.IS_KITKAT_OR_BELOW_KITKAT) {
            mWebView = new XWebView(mActivity);
            WebProxyConfig.WEBVIEW_TYPE = WebProxyConfig.WEBVIEW_AGENTWEB_SAFE_TYPE;
        } else {
            mWebView = new WebView(mActivity);
            WebProxyConfig.WEBVIEW_TYPE = WebProxyConfig.WEBVIEW_DEFAULT_TYPE;
        }
