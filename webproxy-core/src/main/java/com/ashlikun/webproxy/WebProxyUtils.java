...
public class WebProxyUtils {
    ...
    private static final String TAG = WebProxyUtils.class.getSimpleName();
    private static Handler mHandler = null;

    private WebProxyUtils() {
    ...
    public static String getAgentWebFilePath(Context context) {
        return WebProxyConfig.getCachePath(context);
    ...
    static void clearWebViewAllCache(Context context, WebView webView) {
        ...
        try {
            ...
            WebProxyConfig.removeAllCookies(null);
            ...
            clearCacheFolder(new File(WebProxyConfig.getCachePath(context)), 0);
...
//            ignore.printStackTrace();
    ...
    static void getUIControllerAndShowMessage(Activity activity, String message, String from) {
        ...
        AbsWebUIController mAgentWebUIController = mWebParentLayout.getWebUIController();
    ...
    public static AbsWebUIController getAgentWebUIControllerByWebView(WebView webView) {
    ...
    static WebParentLayout getWebParentLayoutByWebView(WebView webView) {
        ...
        AbsWebUIController mAgentWebUIController;
