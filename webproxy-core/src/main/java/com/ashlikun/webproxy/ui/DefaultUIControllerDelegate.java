...
public class DefaultUIControllerDelegate extends AbsWebUIController {
    ...
    public void onJsAlert(WebView view, String url, String message) {
        WebProxyUtils.toastShowShort(view.getContext().getApplicationContext(), message);
    }
        ...
        if (mAskOpenOtherAppDialog == null) {
            mAskOpenOtherAppDialog = new AlertDialog
                    ...
                    .setMessage(mResources.getString(R.string.agentweb_leave_app_and_go_other_page,
                            WebProxyUtils.getApplicationName(mActivity)))
    ...
    public void onShowMessage(String message, String from) {
        ...
        WebProxyUtils.toastShowShort(mActivity.getApplicationContext(), message);
    }
