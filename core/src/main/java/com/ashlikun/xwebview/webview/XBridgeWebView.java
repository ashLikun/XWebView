...
public class XBridgeWebView extends BridgeWebView implements NestedScrollingChild2 {
    ...
    public XBridgeWebView(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    public final void setWebChromeClient(WebChromeClient client) {
        XWebChrome mXWebChrome = new XWebChrome(this);
        mXWebChrome.setDelegate(client);
        mFixedOnReceivedTitle.setWebChromeClient(client);
        super.setWebChromeClient(mXWebChrome);
        setWebChromeClientSupport(mXWebChrome);
    }
    ...
    public final void setWebViewClient(WebViewClient client) {
        XWebClient mXWebClient = new XWebClient(this);
        BridgeWebViewClient bridgeWebViewClient = new BridgeWebViewClient(this);
        bridgeWebViewClient.setDelegate(client);
        mXWebClient.setDelegate(bridgeWebViewClient);
        super.setWebViewClient(mXWebClient);
        setWebViewClientSupport(mXWebClient);
    }
    ...
    public static class XWebClient extends MiddlewareWebClientBase {
        ...
        private XBridgeWebView mXWebView;

        private XWebClient(XBridgeWebView xWebView) {
        ...
        public void onPageStarted(WebView view, String url, Bitmap favicon) {
            ...
            if (mXWebView.mJsCallJavas != null) {
                mXWebView.injectJavaScript();
            }
            if (mXWebView.mInjectJavaScripts != null) {
                mXWebView.injectExtraJavaScript();
            }
            mXWebView.mFixedOnReceivedTitle.onPageStarted();
            mXWebView.fixedAccessibilityInjectorExceptionForOnPageFinished(url);
        }
    ...
    public static class XWebChrome extends MiddlewareWebChromeBase {
        ...
        private XWebChrome(XBridgeWebView xWebView) {
            this.mXWebView = xWebView;
        }

        @Override
        public void onReceivedTitle(WebView view, String title) {
            this.mXWebView.mFixedOnReceivedTitle.onReceivedTitle();
            super.onReceivedTitle(view, title);
        }

        @Override
        public void onProgressChanged(WebView view, int newProgress) {
            if (this.mXWebView.mJsCallJavas != null) {
                this.mXWebView.injectJavaScript();
            }
            if (this.mXWebView.mInjectJavaScripts != null) {
                this.mXWebView.injectExtraJavaScript();
            }
        ...
        public boolean onJsPrompt(WebView view, String url, String message, String defaultValue, JsPromptResult result) {
            if (this.mXWebView.mJsCallJavas != null && JsCallJava.isSafeWebViewCallMsg(message)) {
                ...
                if (interfacedName != null) {
                    JsCallJava mJsCallJava = this.mXWebView.mJsCallJavas.get(interfacedName);
                    if (mJsCallJava != null) {
